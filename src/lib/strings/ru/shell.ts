...
/**
 * Что видят поисковик и превью в мессенджере. Раньше заголовком главной было
 * «Главная | Curio»: слово, которое ничего не говорит о продукте, на
 * единственной странице, которую вообще ищут незнакомые люди.
 */
export const meta = {
  homeTitle: "Curio — что играть дальше из своей библиотеки Steam, по твоим же отзывам",
  description:
    "Curio читает твои отзывы об играх и раскладывает непройденное из библиотеки Steam по тирам — с объяснением, почему именно тебе. Не по жанрам и не по чужим оценкам. Открытый код, работает на твоём ключе от нейросети.",
  demoTitle: "Демо Curio — советы по бэклогу на вымышленном дневнике",
  demoDescription:
    "Как выглядит разбор вкуса и тир-лист бэклога, если ничего не заводить: дневник вымышленного игрока, по нему собраны советы. Без входа и без ключа.",
};
